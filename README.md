# [SOLVED] Problem-Running-Find-Missing-Argument-To-Exec-39
...
>
> ### ➡️ [CLICK HERE TO VIEW THE FULL FIX GUIDE](https://techfixdocs.my.id/problem-running-find-missing-argument-to-exec-39)
>
...
Use the `-type f` option with `grep` instead of `-exec` for a more efficient and correct search
...
👉 **[Go to ErrorFix Hub Full Article](https://techfixdocs.my.id/problem-running-find-missing-argument-to-exec-39)**
